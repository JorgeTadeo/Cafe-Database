			...
			<nav class="navbar left-padding navbar-expand-md  d-none d-md-block navbar-light">
			  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
				  <a class="nav-item nav-link active left-padding" href="/menu.php">All products<span class="sr-only">(current)</span></a>
				...
				<div class="col-md-3 d-none d-xl-block no-left-padding left-padding2 " style="padding-top: 24px;">
					...
					<section class="section1">
						<ul class="no-left-padding">
							...
							<li class="my3"><a class="text-noUnderline color-textBlackSoft text-sm block" href="/videogamess.php">Consoles</a></li>
						</ul>
					</section>
				</div>
					...
					<div style="margin-top: 14px;">
						<nav aria-label="breadcrumb">
						  <ol class="breadcrumb background" style="padding-left: 0px; margin-bottom: 0px;">
								...
								<li class="breadcrumb-item active" aria-current="page">Fountain Drinks</li>
						  </ol>
						</nav>
					</div>
					<h1 class="sb-heading pb4 md-pb5 lg-pb7 text-bold">Drinks</h1>
					<section id="" class="">
						<h2 class="">Soda</h2>
						...
						<div class=" display-block">
							<div class="container-fluid">
								<div class="row">
									<div class="col-sm">
									<img class="circle img-size mb3" src="coke.png" alt="Coke" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Coke</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="sprite2.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Sprite</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="diet-coke.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Diet Coke</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="dr.pepper.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Dr.Pepper</span>
									</div>
								</div>
							</div>
						</div>
