						...
						<div class=" display-block">
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-sm">
									<img class="circle img-size mb3" src="monopoly.jfif" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Monopoly</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="scrabble.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Scrabble</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="connect4.png" alt="" role="presentation">										
