						...
						<div class=" display-block">
							<div class="container-fluid">
								<div class="row">
									...
									<span aria-hidden="true" class="display-block text-align" >Jack Daniels</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="grey.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Grey Goose</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="bombay.jpg" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Bombay</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="patron.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Patron</span>
									</div>
								</div>
							</div>
						</div>
