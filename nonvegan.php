					...
					<div style="margin-top: 14px;">
						<nav aria-label="breadcrumb">
						  <ol class="breadcrumb background" style="padding-left: 0px; margin-bottom: 0px;">
								...
								<li class="breadcrumb-item active" aria-current="page">Non-Vegan</li>
						  </ol>
						</nav>
					</div>
					<h1 class="sb-heading pb4 md-pb5 lg-pb7 text-bold">Food</h1>
					<section id="" class="">
						<h2 class="">Non-Vegan</h2>
						...
						<div class=" display-block">
							<div class="container-fluid">
								<div class="row">
									...
									<span aria-hidden="true" class="display-block text-align" >Carne Asada Tacos</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="burger.jfif" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Cheese Burger</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="steak-and-potatoes.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Steak and Potatoes</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="pasta.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Pasta</span>
									</div>
								</div>
							</div>
						</div>
