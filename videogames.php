						...
						<div class=" display-block">
							<div class="container-fluid">
								<div class="row">
									...
									<span aria-hidden="true" class="display-block text-align" >Xbox</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="ps4.webp" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Playstation</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="gamecube.jpg" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Gamecube</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="n64.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Nintendo 64</span>
									</div>
								</div>
							</div>
						</div>
