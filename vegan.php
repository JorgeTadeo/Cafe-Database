					...
					<div style="margin-top: 14px;">
						<nav aria-label="breadcrumb">
						  <ol class="breadcrumb background" style="padding-left: 0px; margin-bottom: 0px;">
								...
								<li class="breadcrumb-item active" aria-current="page">Vegan</li>
						  </ol>
						</nav>
					</div>
					<h1 class="sb-heading pb4 md-pb5 lg-pb7 text-bold">Food</h1>
					<section id="" class="">
						<h2 class="">Vegan</h2>
						...
						<div class=" display-block">
							<div class="container-fluid">
								<div class="row">
									<div class="col-sm">
									<img class="circle img-size mb3" src="veganpasta.jpg" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Creamy Vegan Pasta</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="veganburger.jfif" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Sweet Potato & Black Bean Burger</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="Mac-n-Cheese.png" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Vegan Mac and Cheese</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="vegantacos.jfif" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Cauliflower Tacos</span>
									</div>
								</div>
							</div>
						</div>
