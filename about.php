...
<html>
  ...
  <body>
	...
	<main>
			...
			<div class="boxsize">
				<div class="div1 py justify-center flex text-center color">
					<div class="font width">
						<p>Here at the Cafedb you can order food, drinks and enjoy our entertainment centers. Our entertainment consists of board games and video game consoles that we hope you will enjoy! <p>
					</div>
				</div>
			</div>
		</div>
		 ...
		 <div class="container-fluid sitewidth no-padding bottom">
		  <div class="row no-gutters">
			<div class="col-lg color justify-center text-center flex items-center color">
			  	<div class="py div1">
					<div class="block">
						<h1 class="sb-heading font1 mb4">
							<span class="width box-sizing">Serving Fresh Coffee</span>
						</h1>
						<div class="font width">
							 Our in house coffee is ground and made fresh on each and everyday. 
						</div>						
					</div>
				</div>
			</div>
			<div class="col-lg">
			  	<div class=" justify-center flex items-center color order-first order-md-last">
					<img class="block" src="coffee-sign.jpg">
				</div>
			</div>
		  </div>
		  </div>
		  ...
		  <div class="row no-gutters">
			...
			<div class="col-lg color justify-center text-center flex items-center color">
			  	<div class="py div1">
					<div class="block">
						<h1 class="sb-heading font1 mb4">
							<span class="width box-sizing">Entertainment</span>
						</h1>
						<div class="font width">
							We have cutting edge video game systems for those who want the latest and greatest. We also have board games for the old fashioned.  
						</div>						
					</div>
				</div>
			</div>
		...
		<div class="sitewidth">
			<p class="color-text BlackSoft py3">© 2020 Cafe Db. All rights reserved.</p>
		</div>
		</footer>
