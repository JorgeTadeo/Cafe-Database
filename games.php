...
<html>
  ...
  <body>
	  <nav class="navbar navbar-bottom navbar-light navbar-expand-sm">
	  <a class="navbar-brand" href="http://localhost/cafedb/welcome.php"><img id="logo" src="/cafedb/pictures/logo.PNG" ></a>
	  ...
	  <div class="collapse navbar-collapse">
		<ul class="navbar-nav mr-auto">
		  <li class="nav-item active">
			<a class="nav-link active" href="http://localhost/cafedb/menu.php">Menu</a>
		  </li>
		  <li class="nav-item active">
			<a class="nav-link" href="http://localhost/cafedb/contact.php">Contact</a>
		  </li>
		  <li class="nav-item active">
			<a class="nav-link"  href="http://localhost/cafedb/about.php">About</a>
		  </li>
		</ul>
		<?php
		if(isset($_SESSION['loggedin'])){
			if($_SESSION["loggedin"]== True){
				...
				echo '<div class="dropdown-menu" aria-labelledby="dropdown03">';
				  echo '<a class="dropdown-item" href="http://localhost/cafedb/order.php">Order</a>';
				  echo '<a class="dropdown-item" href="#">My Rewards</a>';
				  echo '<a class="dropdown-item" href="http://localhost/cafedb/ok.php">History</a>';
				  echo '<a class="dropdown-item" href="http://localhost/cafedb/logout.php">logout</a>';
				echo '</div>';
				echo '</li>';
				echo '</ul>';
			}
			...
			echo '<li class="nav-item active margin"><a class="nav-link" id="login" href="http://localhost/cafedb/login.php">Login</a></li>';
			echo '<li class="nav-item active margin"><a class="nav-link" id="register" href="http://localhost/cafedb/register.php">Register</a></li>';
			echo '</ul>';
		}
		?>
	</div>
				...
				<div class="col-md-3 d-none d-xl-block no-left-padding left-padding2 " style="padding-top: 24px;">
					<section class="section1">
						<ul class="no-left-padding">
							<h4 class="">Drinks</h4>
							<li class="my3"><a class="text-noUnderline color-textBlackSoft text-sm block" href="http://localhost/cafedb/fountaindrinks.php">Fountain Drinks</a></li>
							<li class="my3"><a class="text-noUnderline color-textBlackSoft text-sm block" href="http://localhost/cafedb/alcoholicdrinks.php">Alcoholic Drinks</a></li>
						</ul>
					</section>
					<section class="section1">
						<ul class="no-left-padding">
							<h4 class="">Food</h4>
							<li class="my3"><a class="text-noUnderline color-textBlackSoft text-sm block" href="/menu/drinks/hot-coffees">Non-Vegan</a></li>
							<li class="my3"><a class="text-noUnderline color-textBlackSoft text-sm block" href="/menu/drinks/hot-coffees">Vegan</a></li>
						</ul>
					</section>
					<section class="section1">
						<ul class="no-left-padding">
							<h4 class="">Games</h4>
							<li class="my3"><a class="text-noUnderline color-textBlackSoft text-sm block" href="/menu/drinks/hot-coffees">Board Games</a></li>
							<li class="my3"><a class="text-noUnderline color-textBlackSoft text-sm block" href="/menu/drinks/hot-coffees">Consoles</a></li>
						</ul>
					</section>
				</div>
				<div class="col-md-9 no-left-padding no-right-padding left-padding3">
					<div style="margin-top: 14px;">
						<nav aria-label="breadcrumb">
						  <ol class="breadcrumb background" style="padding-left: 0px; margin-bottom: 0px;">
							    <li class="breadcrumb-item"><a href="#">Menu</a></li>
								<li class="breadcrumb-item active" aria-current="page">Board Games</li>
						  </ol>
						</nav>
					</div>
					<h1 class="sb-heading pb4 md-pb5 lg-pb7 text-bold">Games</h1>
					<section id="" class="">
						<h2 class="">Board Games</h2>
						<hr aria-hidden="true" class=""></hr>
						<div class=" display-block">
							<div class="container-fluid">
								<div class="row">
									<div class="col-sm">
									<img class="circle img-size mb3" src="/cafedb/pictures/uno.PNG" alt="" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Uno</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="/cafedb/pictures/monopoly.JFIF" alt="Starbucks Reserve® Nitro Cold Brew" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Monopoly</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="/cafedb/pictures/scrabble.PNG" alt="Starbucks Reserve® Nitro Cold Brew" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Scrabble</span>
									</div>
									<div class="col-sm">
									<img class="circle img-size mb3" src="/cafedb/pictures/connect4.PNG" alt="Starbucks Reserve® Nitro Cold Brew" role="presentation">										
									<span aria-hidden="true" class="display-block text-align" >Connect 4</span>
									</div>
								</div>
							</div>
						</div>
